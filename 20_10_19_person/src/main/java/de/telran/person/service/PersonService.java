...
public class PersonService {
    ...
    public List<Person> getAllByAgeAfter(int age) {
        return new ArrayList<>(personRepo.findAllByAgeAfter(age));
    }
    ...
    public List<Person> getAllBySecondNameContaining(String part) {
        return new ArrayList<>(personRepo.findAllBySecondNameContaining(part));
    }
}
